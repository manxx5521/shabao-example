 ...
 * <p>Swagger2测试界面访问 http://localhost:8080/swagger-ui.html </p>
 */
@Configuration
@EnableSwagger2
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.xiaoshabao.example.controller"))
...
//    @Bean
    public Docket createApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //需要扫描的包
                .apis(RequestHandlerSelectors.basePackage("com.xiaoshabao.example.api"))
                .paths(PathSelectors.any())
                .build();
    } 
