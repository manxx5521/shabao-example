 ...
 * 
 */
public class TimSort<T> extends ComparatorSort{
	
	public static void main(String[] args) {
//		TimSort.sort(a, 0, a.length, c, null, 0, 0);
		Persion[] ps=new Persion[3];
		list.toArray(ps);
		TimSort.sort(ps, 0, list.size(), new Comparator<Persion>() {
	        @Override
		...
		Arrays.asList(ps).forEach(p->System.out.println(p.getName()));
	}
     ...
     * <p/>
     * 这个常量的值必须2的幂。Tim Perter 在C语言中的实现版本使用了64，但是根据经验这里的版本使用32更合适。
